...
public class BrokerRegistryTest {
    ...
    public void testRegister() throws Exception {
        ...
        BrokerLookupData lookupData = brokerRegistry1.lookup(brokerRegistry2.getLookupServiceAddress());
        Assert.assertNotNull(lookupData);
        Assert.assertEquals(lookupData.getBrokerVersion(), pulsar2.getBrokerVersion());
